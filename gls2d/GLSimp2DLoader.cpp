...
bool LoadGL()
{
	...
	const int functionCount = 24;
	bool result[functionCount];
	...
	result[23] = glUniform1fv =					(void(__stdcall*)(GLint location, GLsizei count, const GLfloat * value))get_proc_address("glUniform1fv");
